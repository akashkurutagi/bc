...
app.post('/valid', upload.single('avatar'), function (req, res, next) {
  ...
  app.post('/profile', upload.single('avatar'), function (req, res,next) {
    ...
    ipfs.add(data, function (err,file){
        ...
        // console.log("fileeeeeeeeeEE:"+fpath);
        ...
        //     }
        //     else {
        //      // console.log("Stats object for: user.html");
        //       myConsole.log("atime:"+stats.atime);
        //       myConsole.log("mtime:"+stats.mtime);
        //       myConsole.log("ctime:"+stats.ctime);
        //       myConsole.log("size:"+stats.size);
        //       myConsole.log("birthtime:"+stats.birthtime);
        //     }
        //   });
        //   myConsole.log("hash:"+hash1);
    })
